...
#The driver is set by default to use Chrome Browser
...
class TestPositiveLoginScenario(unittest.TestCase):
    def setUp(self):
    ...
    # 5. Click log in button and verify the site does NOT update to the main landing page, and returns expected error message
    # 6. Log out of website and close browser window
